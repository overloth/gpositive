...
@section('content')
  <div class="w3-content" style="max-width:1400px">
    ...
    <div class="w3-card-4 w3-margin w3-white ">
      ...
      <div class="article_image" style="background:url('{{$workshop->image}}') no-repeat;display:block;margin-left:auto;margin-right:auto;background-size:cover; width:100%; background-position: 0px -50px; height:500px;"> 
      </div>
