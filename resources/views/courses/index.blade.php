...
@section('content')
 ...
 <div class="w3-content" style="max-width:1400px;background:url('/images/cveceljubicasto.jpg') no-repeat;display:block;background-attachment: fixed;background-size:cover; width:100%;background-position:fixed;">
 <div class="w3-row">
